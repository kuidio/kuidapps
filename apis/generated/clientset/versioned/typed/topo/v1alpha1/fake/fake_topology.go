...
func (c *FakeTopologies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TopologyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(topologiesResource, topologiesKind, c.ns, opts), &v1alpha1.TopologyList{})
...
func (c *FakeTopologies) UpdateStatus(ctx context.Context, topology *v1alpha1.Topology, opts v1.UpdateOptions) (*v1alpha1.Topology, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(topologiesResource, "status", c.ns, topology), &v1alpha1.Topology{})
...
func (c *FakeTopologies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(topologiesResource, c.ns, name, opts), &v1alpha1.Topology{})
...
func (c *FakeTopologies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Topology, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(topologiesResource, c.ns, name, pt, data, subresources...), &v1alpha1.Topology{})
