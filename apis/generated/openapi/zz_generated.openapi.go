...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/kuidio/kuidapps/apis/topo/v1alpha1.Topology":           schema_kuidapps_apis_topo_v1alpha1_Topology(ref),
		"github.com/kuidio/kuidapps/apis/topo/v1alpha1.TopologyList":       schema_kuidapps_apis_topo_v1alpha1_TopologyList(ref),
		"github.com/kuidio/kuidapps/apis/topo/v1alpha1.TopologySpec":       schema_kuidapps_apis_topo_v1alpha1_TopologySpec(ref),
		"github.com/kuidio/kuidapps/apis/topo/v1alpha1.TopologyStatus":     schema_kuidapps_apis_topo_v1alpha1_TopologyStatus(ref),
...
func schema_kuid_apis_condition_v1alpha1_Condition(ref common.ReferenceCallback) common.OpenAPIDefinition {
...
func schema_kuid_apis_condition_v1alpha1_ConditionedStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_kuidapps_apis_topo_v1alpha1_Topology(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kuidio/kuidapps/apis/topo/v1alpha1.TopologySpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/kuidio/kuidapps/apis/topo/v1alpha1.TopologyStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/kuidio/kuidapps/apis/topo/v1alpha1.TopologySpec", "github.com/kuidio/kuidapps/apis/topo/v1alpha1.TopologyStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_kuidapps_apis_topo_v1alpha1_TopologyList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "TopologyClabList contains a list of TopologyClabs",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/kuidio/kuidapps/apis/topo/v1alpha1.Topology"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/kuidio/kuidapps/apis/topo/v1alpha1.Topology", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_kuidapps_apis_topo_v1alpha1_TopologySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_kuidapps_apis_topo_v1alpha1_TopologyStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
