...
// +k8s:conversion-gen=github.com/kuidio/kuidapps/apis/network
// +k8s:defaulter-gen=TypeMeta
// +groupName=network.app.kuid.dev

// v1alpha1 is the v1alpha1 version of the API.
package v1alpha1 // import "github.com/kuidio/kuidapps/apis/network/v1alpha1"
