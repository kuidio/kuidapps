...
func (in *NetworkDeviceBFDInterface) DeepCopyInto(out *NetworkDeviceBFDInterface) {
	*out = *in
	...
	in.BFDLinkParameters.DeepCopyInto(&out.BFDLinkParameters)
}
...
func (in *NetworkDeviceNetworkInstanceProtocolBGP) DeepCopyInto(out *NetworkDeviceNetworkInstanceProtocolBGP) {
	*out = *in
	...
	if in.AddressFamilies != nil {
		...
		*out = make([]*NetworkDeviceNetworkInstanceProtocolBGPAddressFamily, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(NetworkDeviceNetworkInstanceProtocolBGPAddressFamily)
				**out = **in
			}
		}
	}
...
func (in *NetworkDeviceNetworkInstanceProtocolISISInstance) DeepCopyInto(out *NetworkDeviceNetworkInstanceProtocolISISInstance) {
	*out = *in
	...
	if in.Level1 != nil {
		in, out := &in.Level1, &out.Level1
		*out = new(NetworkDeviceNetworkInstanceProtocolISISInstanceLevel)
		**out = **in
	}
	if in.Level2 != nil {
		in, out := &in.Level2, &out.Level2
		*out = new(NetworkDeviceNetworkInstanceProtocolISISInstanceLevel)
		**out = **in
	}
	if in.Interfaces != nil {
...
func (in *NetworkDeviceNetworkInstanceProtocolISISInstanceInterface) DeepCopyInto(out *NetworkDeviceNetworkInstanceProtocolISISInstanceInterface) {
	*out = *in
	...
	if in.Level1 != nil {
		in, out := &in.Level1, &out.Level1
		*out = new(NetworkDeviceNetworkInstanceProtocolISISInstanceInterfaceLevel)
		**out = **in
	}
	if in.Level2 != nil {
		in, out := &in.Level2, &out.Level2
...
func (in *NetworkStatus) DeepCopyInto(out *NetworkStatus) {
	*out = *in
	...
	if in.UsedReferences != nil {
		...
		*out = new(NetworkStatusUsedReferences)
		**out = **in
	}
}
