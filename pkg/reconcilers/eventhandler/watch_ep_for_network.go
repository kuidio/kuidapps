...
type EndpointForNetworkEventHandler struct {
...
func (r *EndpointForNetworkEventHandler) add(ctx context.Context, obj runtime.Object, queue adder) {
	ep, ok := obj.(*infrabev1alpha1.Endpoint)
	if !ok {
		return
	}
	...
	for _, obj := range objList.Items {
		if obj.Spec.Topology == ep.Spec.NodeGroup {
